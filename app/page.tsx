...
export default function Home() {
  ...
  return (
    <div className="[&>*:nth-child(odd)]:bg-[#f9f9f9] [&>*:nth-child(n)]:py-20 space-y-10 ">
      <section id="" className=" section max-sm:h-screen lg:h-screen flex">
        <div className=" space-y-10 sm:space-y-16  text-center justify-evenly  max-w-[1020px] mx-auto max-xl:px-10 flex flex-col ">
          <Hero />
          <Skill />
        </div>
      </section>
